  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-black">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-8">
        ...
        {/* Sport Logos */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 max-w-5xl w-full">
          {/* NFL */}
          <button
          ...
          {/* FIFA World Cup */}
          <button
            onClick={() => handleSportSelect("fifa")}
            className="group relative focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black rounded-2xl"
          >
            <div className="absolute -inset-4 bg-gradient-to-br from-red-500/0 via-orange-500/0 to-red-500/0 group-hover:from-red-500/20 group-hover:via-orange-500/10 group-hover:to-red-500/20 blur-2xl transition-all duration-700 rounded-3xl"></div>

            <div className="relative aspect-square w-full bg-slate-900/50 backdrop-blur-xl rounded-2xl sm:rounded-3xl border border-slate-800 group-hover:border-red-500/50 transition-all duration-500 overflow-hidden group-active:scale-95">
              <div className="absolute inset-0 bg-[linear-gradient(to_right,#0f172a_1px,transparent_1px),linear-gradient(to_bottom,#0f172a_1px,transparent_1px)] bg-[size:24px_24px] opacity-20"></div>
            ...
            <div className="mt-4 sm:mt-6">
              <h2 className="text-xl sm:text-2xl font-black text-white group-hover:text-red-400 transition-colors duration-300" style={{ fontFamily: "'Orbitron', sans-serif" }}>
                FIFA
              </h2>
            </div>
          </button>
