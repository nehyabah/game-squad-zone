...
import { SixNationsPersonalInsights } from "./SixNationsPersonalInsights";
import { SixNationsSquadOverview } from "./SixNationsSquadOverview";
import { SixNationsMemberComparison } from "./SixNationsMemberComparison";
import { Button } from "@/components/ui/button";
import { ChevronDown, ChevronUp, Users, User, BarChart3 } from "lucide-react";

interface SixNationsStatisticsTabProps {
  squadId: string;
  userId: string;
}

export const SixNationsStatisticsTab = ({ squadId, userId }: SixNationsStatisticsTabProps) => {
  ...
  return (
    <div className="space-y-6 sm:space-y-10 pb-6 sm:pb-10">
      ...
      <section className="group">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-muted-foreground mt-0.5">
                Team-wide performance and accuracy
              </p>
            </div>
          </div>
          <Button
        ...
        {expandedSections.squad && (
          <div className="animate-in fade-in-50 duration-300">
            <SixNationsSquadOverview squadId={squadId} />
          </div>
        )}
      </section>
      ...
      <section className="group">
        ...
        {expandedSections.comparison && (
          <div className="animate-in fade-in-50 duration-300">
            <SixNationsMemberComparison squadId={squadId} />
          </div>
        )}
      </section>
      ...
      <section className="group">
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-muted-foreground mt-0.5">
                Your individual stats and streaks
              </p>
            </div>
          </div>
          <Button
        ...
        {expandedSections.personal && (
          <div className="animate-in fade-in-50 duration-300">
            <SixNationsPersonalInsights userId={userId} squadId={squadId} />
          </div>
        )}
      </section>
    </div>
